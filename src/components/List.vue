    ...
    <div class="jumbotron hk p-4">
      ...
      <div class="row justify-content-center">
        <div class="col-sm-9 col-md-9">
          <b-card
            no-body
            class="overflow-hidden dff my-5"
          ...
          >
            <b-row no-gutters>
              <b-col md="6">
                <b-card no-body :img-src="`${product.image}`" alt="Image" class="rounded-0"></b-card>
              </b-col>
              <b-col md="6">
                <b-card-body>
                  ...
                  <b-card-text
                    class="pull-left ty mt-2 text-muted"
                  >{{product.description}}o accusamus. Quis, aut.</b-card-text>
